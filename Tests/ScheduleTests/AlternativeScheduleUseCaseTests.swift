...
final class AlternativeScheduleUseCaseTests: XCTestCase {
    ...
    func testAltFRFT() {
        ...
        let testObservable = scheduler.createHotObservable([
            next(100, ResponseEntity(numOfResponses: 5, milliseconds: 0)),
            next(200, ResponseEntity(numOfResponses: 7, milliseconds: 0)),
            next(300, ResponseEntity(numOfResponses: 10, milliseconds: 5000)),
            next(400, ResponseEntity(numOfResponses: 10, milliseconds: 10000)),
            next(500, ResponseEntity(numOfResponses: 1000, milliseconds: 10000)),
            next(600, ResponseEntity(numOfResponses: 1001, milliseconds: 10000)),
            completed(completedTime)
            ])
