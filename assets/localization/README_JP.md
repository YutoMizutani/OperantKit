...
環境を制御することにより，随伴して生じる行動の予測と制御を行おうとするのが行動分析学です。

ある行動のあとにその個体に対して環境に変化が生じた。その変化を知覚し，行動を変容するようになります。
...
この場合ですと，イヌの例は「正の強化」であり，夜更しの例は「負の罰」となります。

一方で，パチンコに再び訪れるのはどうしてでしょうか?もしかしたらその人がは，別の台に移動するかもしれません。どうしてでしょうか。

窓を開けて寝てから，風邪をひくまでは数時間の遅延があります。その時間はいつまで続くのでしょうか。窓を閉めるのか，羽織を着るのか，どうすれば予測できるのでしょうか。そもそも風邪をひいた原因は窓を開けたことではないかもしれません，なぜ行動が変容したのでしょうか。
